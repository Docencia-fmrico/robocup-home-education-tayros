...
#ifndef BBX_TO_3D_BBXTO3D_H
#define BBX_TO_3D_BBXTO3D_H
...
public:
  ...
  void callback_3dpoint(const sensor_msgs::ImageConstPtr& image, const sensor_msgs::CameraInfoConstPtr& cam_info);
